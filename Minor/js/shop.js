...
// createProduct("shirt","mens","Matte Black","item-men2","600","s","white");
// createProduct("shirt","mens","Salmon Shed","item-men3","300","s","white");
 
// createProduct("dress","womens","Pete de Blaca","dress1","500","s","black");
// createProduct("dress","womens","Knited Pearl","dress2","500","s","white");
// createProduct("dress","womens","Ocean Bliss","dress3","500","s","blue");
// createProduct("dress","womens","Executive","dress4","500","s","black");
// createProduct("dress","womens","Mesmr","dress5","500","s","black");
// createProduct("dress","womens","Desire Nenm","dress6","500","s","pink");
// createProduct("dress","womens","Silver Pearl","dress7","500","s","grey");
// createProduct("dress","womens","Classic Solid","dress8","500","s","black");
